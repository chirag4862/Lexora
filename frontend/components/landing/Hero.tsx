...
/**
 * The glass-scales composition. Built at a fixed 720x700 canvas with
 * absolutely-positioned pixel values — reused as-is on mobile inside a
 * `transform: scale()` wrapper rather than rewritten with fluid units.
 */
...
function MobileHero() {
  return (
    <section className="relative z-10 flex flex-col items-center gap-7 px-5 pt-14 pb-16 text-center sm:px-8 sm:pt-16 sm:pb-20 lg:hidden">
      <h1
      ...
      >
        <span
          ...
          style={{ fontSize: "clamp(2rem, 9vw, 3.1rem)", lineHeight: 0.95 }}
        >
          Know your
        </span>
        <span
          ...
          style={{
            fontSize: "clamp(3.2rem, 16vw, 5.6rem)",
            lineHeight: 0.85,
            marginTop: 2,
            background:
            ...
            textShadow: "0 0 40px rgba(var(--gold-rgb),0.35)",
          }}
        >
          rights.
        </span>
        <span
          ...
          style={{ fontSize: "clamp(2.2rem, 10vw, 3.4rem)", lineHeight: 0.95, marginTop: 6 }}
        >
          Instantly.
        </span>
      </h1>
      ...
      <p
        className="font-body text-[11px] tracking-[0.14em] whitespace-nowrap uppercase"
        style={{ color: "rgba(255,255,255,0.5)" }}
      >
        BNS · BNSS · BSA &nbsp;·&nbsp; every answer cited
      </p>

      {/* scaled-down reuse of the desktop scale composition */}
      <div
        className="relative mx-auto"
        style={{ width: 300, height: 292, overflow: "hidden" }}
      >
        <div
          style={{
            position: "relative",
      ...
      <p
        className="m-0 max-w-[420px] text-center text-[15px] leading-[1.5]"
      ...
      <div className="flex w-full max-w-xs flex-col gap-3">
        <Link
          href="/login"
          className="rounded-pill inline-flex items-center justify-center gap-[9px] px-[30px] py-[15px] text-[15.5px] font-semibold"
          style={{
            background:
        ...
        <a
          href="#"
          className="rounded-pill inline-flex items-center justify-center gap-[9px] px-[28px] py-[15px] text-[15.5px] font-medium"
          style={{
...
export default function Hero() {
  return (
    <>
      {/* desktop: unchanged pixel-precise composition */}
      <section className="relative z-10 hidden lg:block" style={{ height: 960 }}>
        <SceneVisual />
      ...
      {/* mobile / tablet: simplified stacked layout, below lg */}
      <MobileHero />
    </>
  );
}
