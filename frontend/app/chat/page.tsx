...
function ChatShell() {
  ...
  return (
    <div className="relative flex h-dvh w-full items-center justify-center overflow-hidden bg-bg p-0 lg:p-[26px]">
      <div
      ...
      <div
        className="relative flex h-full w-full overflow-hidden rounded-none lg:rounded-[22px]"
        style={{
          background: "#0A0F1B",
      ...
      >
        ...
        <main className="relative flex flex-1 flex-col overflow-hidden">
          {/* mobile header: hamburger toggle + wordmark */}
          <div
          ...
          >
            <button
              ...
              className="lex-icon-btn flex h-9 w-9 items-center justify-center rounded-lg"
            ...
            <span className="font-heading text-[15px] font-bold text-white">Lexora</span>
          </div>
          ...
          {view === "welcome" ? (
            ...
            <div className="relative flex flex-1 flex-col overflow-hidden">
              <div
                className="flex items-center px-4 py-3 lg:px-8 lg:py-4"
                style={{
